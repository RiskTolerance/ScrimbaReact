	...
	return (
		<div
			...
			<div className='w-1/2 min-w-[550px] max-w-[770px]  bg-slate-600 flex relative flex-col overflow-clip rounded-lg shadow-2xl'>
				<div className='flex p-8 justify-between items-center h-[100px] bg-gray-950 border-b-4 border-sopd border-[#61dafb]'>
				...
				<div className='flex justify-start bg-gray-900'>
				...
				<div className='absolute -right-[125px] bottom-7 opacity-5'>
